...
CC_MAPPING MAP[128] = {
    ...
    { MACRO, 56, 0, 127, 2, 0 }, // 1 C atk
    { MACRO, 57, 0, 127, 2, 1 }, // 1 C dcy Level
    { MACRO, 58, 0, 127, 2, 2 }, // 1 C sus Level
    { MACRO, 59, 0, 127, 2, 3 }, // 1
    { MACRO, 60, 0, 127, 3, 0 }, // 1
    { MACRO, 61, 0, 127, 3, 1 }, // 1
    { MACRO, 62, 0, 127, 3, 2 }, // 1
    { MACRO, 63, 0, 127, 3, 3 }, // 1
    ...
    { SYSEX, 83, 0, 99, 0, 89 }, // d
    { SYSEX, 84, 0, 99, 0, 90 }, // s
    { SYSEX, 85, 0, 99, 0, 91 }, // r
    { SYSEX, 86, 0, 99, 0, 67 }, // op3 A
    { SYSEX, 87, 0, 99, 0, 68 }, // d
    { SYSEX, 88, 0, 99, 0, 69 }, // s
    { SYSEX, 89, 0, 99, 0, 70 }, // r
    { SYSEX, 90, 0, 99, 0, 46 }, // op 4a
    { SYSEX, 91, 0, 99, 0, 47 }, // d
    { SYSEX, 92, 0, 99, 0, 48 }, // s
    { SYSEX, 93, 0, 99, 0, 49 }, // r
    { SYSEX, 94, 0, 99, 0, 25 }, // op5 a
    { SYSEX, 95, 0, 99, 0, 26 }, // d
    { SYSEX, 96, 0, 99, 0, 27 }, // s
    { SYSEX, 97, 0, 99, 0, 28 }, // r
    { SYSEX, 98, 0, 99, 0, 4 }, // op6a
    { SYSEX, 99, 0, 99, 0, 5 }, // d
    { SYSEX, 100, 0, 99, 0, 6 }, // s
    { SYSEX, 101, 0, 99, 0, 7 }, // r
    ...
    { MACRO, 111, 0, 127, 0, 0 }, // 1 MACROS C ATTACK
    { MACRO, 112, 0, 127, 0, 1 }, // 1  DCY
    { MACRO, 113, 0, 127, 0, 2 }, // 1
    { MACRO, 114, 0, 127, 0, 3 }, // 1
    { MACRO, 115, 0, 127, 1, 0 }, // 1 MACROS M Attach = 0,
    { MACRO, 116, 0, 127, 1, 1 }, // 1
    { MACRO, 117, 0, 127, 1, 2 }, // 1
    { MACRO, 118, 0, 127, 1, 3 }, // 1
